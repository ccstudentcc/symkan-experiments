...
def build_dataset(
    ...
    @param validation_ratio 验证集比例；默认 `0.0` 表示禁用。
    @param seed 验证集切分随机种子。
    @param min_val_samples 验证集最少样本数。
    @return dict 包含 `train_input/train_label/val_input/val_label/test_input/test_label` 的张量字典。
    """
