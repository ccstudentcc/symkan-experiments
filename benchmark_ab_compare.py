...
def main() -> None:
    ...
    parser.add_argument("--root", default="benchmark_ab", help="benchmark root directory")
    ...
    parser.add_argument("--output", default="benchmark_ab/comparison", help="output directory")
