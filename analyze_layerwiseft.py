...
不需要重新训练：直接读取已有的 benchmark_ablation/full/ 与
benchmark_ablation/wolayerwiseft/ 目录下的实验产物，从以下几个维度做对比：
...
def main() -> None:
    ...
    parser.add_argument(
        "--ablation-dir", default="benchmark_ablation",
    ...
    root = Path(args.ablation_dir).resolve()
    full_dir = root / "full"
